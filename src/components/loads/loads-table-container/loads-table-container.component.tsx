...
import { useStyles } from './loads-table-container.styles';
...
import LoadsTable from '../loads-table/events-table.component';


const LoadsTableContainer: FC = (props): ReactElement => {
